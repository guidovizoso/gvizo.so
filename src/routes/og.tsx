...
function PostOgImage({ title }: { title: string }) {
  return (
    <div
      style={{
        backgroundColor: "#ffffff",
  ...
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        if (title) {
          return new ImageResponse(<PostOgImage title={title} />, {
            width: 1200,
            height: 630,
          });
        }
